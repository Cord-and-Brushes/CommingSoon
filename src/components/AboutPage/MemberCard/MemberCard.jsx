...
// <div class="circle89"></div>
// <div class="card89-inner flex p-2 flex-col items-center">
//   <img src={image} className="rounded-md"/>
//   <div className="pt-4 flex flex-col items-center">
//       <h1 className="text-center text-[18px] font-bold">{name}</h1>
//       <p className="text-center mt-2">{designation}</p>
//       <MyButton buttonText="Follow"/>
//       <button className="px-4 py-2 mt-3">Follow</button>
//   </div>
// </div>
// </div>
