    ...
    <div className="flex justify-center items-start pt-2 px-12 ">
      <div className="w-full max-w-4xl rounded-2xl shadow-2xl px-12 py-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          <div className="bg-white p-6 rounded-xl shadow-inner flex flex-col items-center w-full">
            <h2 className="text-2xl font-semibold text-purple-700 mb-8 text-center">
              Contact Information
            </h2>
            <ul className="space-y-5 text-gray-700 text-center md:text-left">
